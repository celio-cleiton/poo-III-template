...
export class AccountsController { 
    ...
    public getAccountsId = async (req: Request, res: Response) => {
        try {
    ...
    public createAccounts = async (req: Request, res: Response) => {
        try {
    ...
    public updateAccounts = async (req: Request, res: Response) => {
        try {
            const id = req.params.id
